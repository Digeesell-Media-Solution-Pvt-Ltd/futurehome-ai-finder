        ...
        <div className="container-luxury">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {areas.map((area, index) => (
              ...
              >
                <Link
                  to={{"Dubai Marina": "/areas/dubai-marina", "Downtown Dubai": "/areas/downtown-dubai", "Palm Jumeirah": "/areas/palm-jumeirah", "Business Bay": "/areas/business-bay", "Dubai Hills": "/areas/dubai-hills", "Jumeirah Village Circle": "/areas/jvc"}[area] || `/projects?area=${encodeURIComponent(area)}`}
