...
const investmentPoints = [
  { icon: Plane, title: "Al Maktoum International Airport", desc: "Anchored by the world's largest planned airport — a catalyst for long-term growth and connectivity." },
  { icon: Building2, title: "Expo 2020 Legacy Infrastructure", desc: "Massive infrastructure from Expo City Dubai continues to drive development, jobs, and demand in the area." },
  { icon: DollarSign, title: "Affordable with Growth Potential", desc: "Some of Dubai's most competitive entry prices with significant upside as infrastructure matures." },
  { icon: TrendingUp, title: "Ideal for First-Time Investors", desc: "Value-driven pricing and flexible payment plans make it accessible for first-time buyers and investors." },
];
          ...
          <div className="container-luxury relative z-10">
            <motion.div {...fadeUp} className="max-w-3xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-semibold leading-tight mb-6">
                <span className="text-primary">Dubai South</span> — The Future Gateway
              </h1>
              <p className="text-lg text-white/70 max-w-2xl">
                Affordable off-plan properties in one of Dubai's most promising master-planned districts.
              </p>
              <div className="mt-8 flex flex-wrap gap-4">
                <Button variant="gold" size="lg" asChild>
                  <Link to="/projects?area=Dubai%20South">
                    Browse Projects
        ...
        <section className="py-16 lg:py-20">
          <div className="container-luxury">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="max-w-3xl mx-auto text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground mb-6">About Dubai South</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Dubai South is a 145 sq. km city designed around Al Maktoum Airport and Expo City, offering value-driven homes with futuristic planning and infrastructure. Envisioned as a city within a city, it encompasses residential, commercial, logistics, and aviation zones — positioning it as one of Dubai's most ambitious long-term development projects.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-20 bg-cream">
          <div className="container-luxury">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground">Why Dubai South?</h2>
            </motion.div>
        ...
        <section className="py-16 lg:py-20">
          <div className="container-luxury">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground mb-4">Projects in Dubai South</h2>
              <p className="text-muted-foreground max-w-xl mx-auto">Browse verified off-plan projects in Dubai South from leading developers.</p>
            </motion.div>
            <div className="text-center">
              <Button variant="hero" asChild>
                <Link to="/projects?area=Dubai%20South">
                  View All Dubai South Projects
          ...
          <div className="container-luxury">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center p-10 md:p-16 bg-charcoal rounded-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="text-2xl md:text-3xl font-display font-medium text-white mb-4">Start Your Dubai South Journey</h2>
                <p className="text-white/60 mb-8 max-w-xl mx-auto">Let AI shortlist ideal properties in Dubai South for you.</p>
                <Button variant="gold" size="lg" asChild>
                  <Link to="/ai-search">
