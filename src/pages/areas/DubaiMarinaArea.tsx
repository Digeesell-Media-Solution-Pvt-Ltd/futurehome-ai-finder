...
const investmentPoints = [
  { icon: MapPin, title: "Prime Waterfront Location", desc: "Iconic marina promenade with stunning yacht views and direct beach access." },
  { icon: TrendingUp, title: "High Rental Yields", desc: "Strong capital appreciation and consistent rental demand from professionals and tourists." },
  { icon: Train, title: "Excellent Connectivity", desc: "Direct metro, tram & Sheikh Zayed Road access for seamless commuting." },
  { icon: Building, title: "Luxury Developments", desc: "Home to premium off-plan and ready developments from top-tier developers." },
  { icon: Users, title: "Expat & Investor Hub", desc: "Popular with expats, professionals, and tourists — a truly cosmopolitan community." },
];
          ...
          <div className="container-luxury relative z-10">
            <motion.div {...fadeUp} className="max-w-3xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-semibold leading-tight mb-6">
                Explore Off-Plan Projects in{" "}
                <span className="text-primary">Dubai Marina</span>
              </h1>
              <p className="text-lg text-white/70 max-w-2xl">
                Discover luxury waterfront living and investment opportunities in Dubai Marina — one of the UAE's most iconic neighborhoods.
              </p>
              <div className="mt-8 flex flex-wrap gap-4">
                <Button variant="gold" size="lg" asChild>
                  <Link to="/projects?area=Dubai%20Marina">
                    Browse Projects
        ...
        <section className="py-16 lg:py-20">
          <div className="container-luxury">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground mb-6">About Dubai Marina</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Dubai Marina is a premium waterfront district featuring upscale apartments, skyscrapers, and vibrant lifestyle amenities. Known for its marina promenade, fine dining, and easy access to business hubs, it attracts both residents and investors alike. The area spans a 3.5km stretch along a man-made canal, offering a unique blend of urban living and waterfront serenity.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-20 bg-cream">
          <div className="container-luxury">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground">Why Invest in Dubai Marina?</h2>
            </motion.div>
        ...
        <section className="py-16 lg:py-20">
          <div className="container-luxury">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground mb-4">Featured Projects in Dubai Marina</h2>
              <p className="text-muted-foreground max-w-xl mx-auto">
                Browse verified off-plan projects located in and around Dubai Marina from leading developers.
              </p>
            </motion.div>
            <div className="text-center">
              <Button variant="hero" asChild>
                <Link to="/projects?area=Dubai%20Marina">
                  View All Dubai Marina Projects
            ...
            >
              ...
              <div className="relative z-10">
                <h2 className="text-2xl md:text-3xl font-display font-medium text-white mb-4">
                  Looking for a property in Dubai Marina?
                </h2>
                <p className="text-white/60 mb-8 max-w-xl mx-auto">
                  Use our AI property search tool to discover the best fit for your needs.
                </p>
                <Button variant="gold" size="lg" asChild>
                  <Link to="/ai-search">
                    <Sparkles className="w-5 h-5 mr-2" />
                    Start AI Property Match
                  </Link>
                </Button>
              </div>
            </motion.div>
