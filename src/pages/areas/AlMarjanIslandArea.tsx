...
const investmentPoints = [
  { icon: TrendingUp, title: "Emerging Entertainment Hub", desc: "Ras Al Khaimah is positioning Al Marjan Island as a world-class entertainment and hospitality destination with landmark developments." },
  { icon: Waves, title: "Waterfront Branded Residences", desc: "Premium beachfront branded residences from international hospitality brands offering resort-style living." },
  { icon: Home, title: "Ideal for Second-Home Investors", desc: "Attractive pricing and coastal lifestyle make it a top pick for second-home and holiday-home investors." },
  { icon: Hotel, title: "Growing Tourism & Hotel Zones", desc: "Rapid expansion of five-star hotels and tourism infrastructure driving sustained demand and appreciation." },
];
          ...
          <div className="container-luxury relative z-10">
            <motion.div {...fadeUp} className="max-w-3xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-semibold leading-tight mb-6">
                <span className="text-primary">Al Marjan Island</span> — RAK's Investment Coastline
              </h1>
              <p className="text-lg text-white/70 max-w-2xl">
                An emerging luxury destination with beachfront towers and resort-style living.
              </p>
              <div className="mt-8 flex flex-wrap gap-4">
                <Button variant="gold" size="lg" asChild>
                  <Link to="/projects?area=Al%20Marjan%20Island">
                    Browse Projects
        ...
        <section className="py-16 lg:py-20">
          <div className="container-luxury">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="max-w-3xl mx-auto text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground mb-6">About Al Marjan Island</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                This man-made island in Ras Al Khaimah is poised to become a global tourism and investment hub — offering stunning seafront residences and hospitality projects. Spanning four coral-shaped islands, Al Marjan Island combines pristine beaches, crystal-clear waters, and ambitious development plans that are attracting international investors and global hospitality brands.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-20 bg-cream">
          <div className="container-luxury">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground">Why Al Marjan Island is on the Radar</h2>
            </motion.div>
        ...
        <section className="py-16 lg:py-20">
          <div className="container-luxury">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground mb-4">Projects in Al Marjan Island</h2>
              <p className="text-muted-foreground max-w-xl mx-auto">Browse verified off-plan projects on Al Marjan Island from leading developers.</p>
            </motion.div>
            <div className="text-center">
              <Button variant="hero" asChild>
                <Link to="/projects?area=Al%20Marjan%20Island">
                  View All Al Marjan Island Projects
          ...
          <div className="container-luxury">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center p-10 md:p-16 bg-charcoal rounded-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="text-2xl md:text-3xl font-display font-medium text-white mb-4">Explore the Coastline</h2>
                <p className="text-white/60 mb-8 max-w-xl mx-auto">Use AI to discover investment-ready projects on Al Marjan Island.</p>
                <Button variant="gold" size="lg" asChild>
                  <Link to="/ai-search">
