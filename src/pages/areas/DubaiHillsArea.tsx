...
import { MapPin, TrendingUp, TreePine, GraduationCap, Building, ArrowRight, Sparkles } from "lucide-react";
...
const investmentPoints = [
  { icon: TreePine, title: "Golf Community & Central Park", desc: "An 18-hole championship golf course and expansive central park offering a resort-style suburban lifestyle." },
  { icon: GraduationCap, title: "Self-Contained Community", desc: "Schools, hospitals, and Dubai Hills Mall all within the community — everything residents need at their doorstep." },
  { icon: Building, title: "Wide Range of Options", desc: "From affordable apartments to ultra-luxury villas — a diverse portfolio catering to every investor profile." },
  { icon: TrendingUp, title: "Emaar – Brand Trust", desc: "Developed by Emaar, one of the UAE's most trusted developers with a proven track record of delivery." },
];
...
export default function DubaiHillsArea() {
  return (
    <div className="min-h-screen bg-background">
      <SeoHead
        title="Dubai Hills Area Guide - Off-Plan Projects & Investments"
        description="Explore off-plan projects in Dubai Hills Estate. A green master-planned community by Emaar with golf courses, parks, and premium villas and apartments."
        canonicalPath="/areas/dubai-hills"
      />
      <ProgrammaticJsonLd
        data={[breadcrumbListSchema([
          { name: "Home", path: "/" },
          { name: "Areas", path: "/areas" },
          { name: "Dubai Hills", path: "/areas/dubai-hills" },
        ])]}
      />
          ...
          <div className="container-luxury relative z-10">
            <motion.div {...fadeUp} className="max-w-3xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-semibold leading-tight mb-6">
                Tranquility & Luxury at{" "}
                <span className="text-primary">Dubai Hills</span>
              </h1>
              <p className="text-lg text-white/70 max-w-2xl">
                A green master-planned community with golf courses, parks, and premium off-plan villas and apartments.
              </p>
              <div className="mt-8 flex flex-wrap gap-4">
                <Button variant="gold" size="lg" asChild>
                  <Link to="/projects?area=Dubai%20Hills">
                    Browse Projects
        ...
        <section className="py-16 lg:py-20">
          <div className="container-luxury">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground mb-6">About Dubai Hills</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Dubai Hills Estate offers a peaceful yet central lifestyle, ideal for families and long-term investors seeking value with lifestyle perks. Spanning over 11 million square meters, this master-planned community by Emaar blends lush green spaces, world-class amenities, and premium residences into one of Dubai's most desirable addresses.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-20 bg-cream">
          <div className="container-luxury">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground">Why Dubai Hills is an Investor Favorite</h2>
            </motion.div>
        ...
        <section className="py-16 lg:py-20">
          <div className="container-luxury">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground mb-4">Dubai Hills Projects</h2>
              <p className="text-muted-foreground max-w-xl mx-auto">
                Browse verified off-plan projects in Dubai Hills Estate from leading developers.
              </p>
            </motion.div>
            <div className="text-center">
              <Button variant="hero" asChild>
                <Link to="/projects?area=Dubai%20Hills">
                  View All Dubai Hills Projects
            ...
            >
              ...
              <div className="relative z-10">
                <h2 className="text-2xl md:text-3xl font-display font-medium text-white mb-4">
                  Find Your Space in Dubai Hills
                </h2>
                <p className="text-white/60 mb-8 max-w-xl mx-auto">
                  AI assistant can help you pick your perfect project.
                </p>
                <Button variant="gold" size="lg" asChild>
                  <Link to="/ai-search">
