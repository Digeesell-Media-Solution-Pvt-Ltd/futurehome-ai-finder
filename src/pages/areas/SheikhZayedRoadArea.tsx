...
const investmentPoints = [
  { icon: Landmark, title: "Central Business & Residential Axis", desc: "Dubai's main artery connecting Trade Centre to Marina — the ultimate address for commerce, hospitality, and premium living." },
  { icon: Building2, title: "Home to Supertall Towers", desc: "A skyline defined by iconic supertall developments, offering panoramic views, branded residences, and architectural prestige." },
  { icon: Crown, title: "Walkable Zones Near Downtown & DIFC", desc: "Minutes from DIFC, Downtown Dubai, and City Walk — blending corporate convenience with world-class lifestyle amenities." },
  { icon: TrendingUp, title: "Ideal for High-End Investment", desc: "Strong capital appreciation driven by limited supply, premium demand, and proximity to Dubai's most sought-after landmarks." },
];
          ...
          <div className="container-luxury relative z-10">
            <motion.div {...fadeUp} className="max-w-3xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-semibold leading-tight mb-6">
                <span className="text-primary">Sheikh Zayed Road</span> — Where Everything Connects
              </h1>
              <p className="text-lg text-white/70 max-w-2xl">
                The heartbeat of Dubai — SZR offers high-rise living, unmatched accessibility, and prestige like no other address.
              </p>
              <div className="mt-8 flex flex-wrap gap-4">
                <Button variant="gold" size="lg" asChild>
                  <Link to="/projects?area=Sheikh%20Zayed%20Road">Browse Projects<ArrowRight className="w-4 h-4 ml-1" /></Link>
                </Button>
        ...
        <section className="py-16 lg:py-20">
          <div className="container-luxury">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="max-w-3xl mx-auto text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground mb-6">About Sheikh Zayed Road</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Running from Trade Centre to Dubai Marina, Sheikh Zayed Road is a top choice for investors seeking central, high-rise luxury in new and branded towers. As Dubai's most prestigious corridor, it offers unrivalled connectivity, landmark architecture, and a lifestyle defined by proximity to the city's finest destinations.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-20 bg-cream">
          <div className="container-luxury">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground">Why SZR is Unmatched</h2>
            </motion.div>
        ...
        <section className="py-16 lg:py-20">
          <div className="container-luxury">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground mb-4">New Projects on SZR</h2>
              <p className="text-muted-foreground max-w-xl mx-auto">Browse verified off-plan projects on Sheikh Zayed Road from leading developers.</p>
            </motion.div>
            <div className="text-center">
              <Button variant="hero" asChild>
                <Link to="/projects?area=Sheikh%20Zayed%20Road">View All SZR Projects<ArrowRight className="w-4 h-4 ml-2" /></Link>
              </Button>
            </div>
          </div>
        </section>
          ...
          <div className="container-luxury">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center p-10 md:p-16 bg-charcoal rounded-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="text-2xl md:text-3xl font-display font-medium text-white mb-4">Explore Landmark Projects</h2>
                <p className="text-white/60 mb-8 max-w-xl mx-auto">Use AI-powered recommendations to shortlist prime projects on Sheikh Zayed Road.</p>
                <Button variant="gold" size="lg" asChild>
                  <Link to="/ai-search"><Sparkles className="w-5 h-5 mr-2" />Find Projects</Link>
                </Button>
              </div>
            </motion.div>
          </div>
