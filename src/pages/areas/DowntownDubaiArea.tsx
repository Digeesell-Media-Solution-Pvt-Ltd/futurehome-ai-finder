...
const investmentPoints = [
  { icon: Landmark, title: "Global Landmarks", desc: "Proximity to the Burj Khalifa, Dubai Mall, and Dubai Opera — the world's most recognized destinations." },
  { icon: TrendingUp, title: "High ROI Luxury", desc: "Premium real estate commanding strong rental yields and consistent capital appreciation." },
  { icon: Train, title: "DIFC & Business Bay Access", desc: "Excellent connectivity to Dubai's financial corridor and major business districts." },
  { icon: Building, title: "Capital Appreciation", desc: "Strong long-term value growth backed by world-class infrastructure and ongoing development." },
];
          ...
          <div className="container-luxury relative z-10">
            <motion.div {...fadeUp} className="max-w-3xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-semibold leading-tight mb-6">
                Luxury Living in{" "}
                <span className="text-primary">Downtown Dubai</span>
              </h1>
              <p className="text-lg text-white/70 max-w-2xl">
                Home to the Burj Khalifa, Dubai Mall, and iconic skylines — explore the heart of Dubai's real estate investments.
              </p>
              <div className="mt-8 flex flex-wrap gap-4">
                <Button variant="gold" size="lg" asChild>
                  <Link to="/projects?area=Downtown%20Dubai">
                    Browse Projects
        ...
        <section className="py-16 lg:py-20">
          <div className="container-luxury">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground mb-6">About Downtown Dubai</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Downtown Dubai is a global landmark destination with world-class infrastructure, luxury residences, and vibrant retail. It's a high-demand zone for investors and lifestyle seekers alike. Anchored by the Burj Khalifa and the Dubai Mall, the district offers an unmatched blend of culture, commerce, and cosmopolitan living.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-20 bg-cream">
          <div className="container-luxury">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground">Why Invest in Downtown Dubai?</h2>
            </motion.div>
        ...
        <section className="py-16 lg:py-20">
          <div className="container-luxury">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground mb-4">Featured Off-Plan Projects in Downtown Dubai</h2>
              <p className="text-muted-foreground max-w-xl mx-auto">
                Browse verified off-plan projects in and around Downtown Dubai from leading developers.
              </p>
            </motion.div>
            <div className="text-center">
              <Button variant="hero" asChild>
                <Link to="/projects?area=Downtown%20Dubai">
                  View All Downtown Dubai Projects
            ...
            >
              ...
              <div className="relative z-10">
                <h2 className="text-2xl md:text-3xl font-display font-medium text-white mb-4">
                  Match with a Project in Downtown
                </h2>
                <p className="text-white/60 mb-8 max-w-xl mx-auto">
                  Let our AI assistant recommend a property that suits your lifestyle.
                </p>
                <Button variant="gold" size="lg" asChild>
                  <Link to="/ai-search">
