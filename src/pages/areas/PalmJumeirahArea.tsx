...
const investmentPoints = [
  { icon: Crown, title: "Iconic Global Address", desc: "One of the world's most recognizable landmarks — a prestigious address that commands global attention." },
  { icon: Shield, title: "Limited Supply, High Value", desc: "Finite land on the Palm means limited inventory and strong long-term capital appreciation." },
  { icon: Building, title: "Branded Residences", desc: "Home to high-end hospitality and branded residences from Atlantis, Six Senses, and more." },
  { icon: TrendingUp, title: "Exclusivity for Investors", desc: "Ultra-premium positioning attracts discerning investors seeking rare beachfront opportunities." },
];
          ...
          <div className="container-luxury relative z-10">
            <motion.div {...fadeUp} className="max-w-3xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-semibold leading-tight mb-6">
                <span className="text-primary">Palm Jumeirah</span> — Iconic Waterfront Living
              </h1>
              <p className="text-lg text-white/70 max-w-2xl">
                Explore ultra-premium developments on the world's most famous man-made island.
              </p>
              <div className="mt-8 flex flex-wrap gap-4">
                <Button variant="gold" size="lg" asChild>
                  <Link to="/projects?area=Palm%20Jumeirah">
                    Browse Projects
        ...
        <section className="py-16 lg:py-20">
          <div className="container-luxury">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground mb-6">About Palm Jumeirah</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                A symbol of Dubai's ambition, Palm Jumeirah is a destination for ultra-luxury residences, sea views, and private beaches. Shaped like a palm tree and stretching into the Arabian Gulf, this engineering marvel hosts some of the world's most exclusive addresses, five-star resorts, and high-end branded residences.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-20 bg-cream">
          <div className="container-luxury">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground">Why Invest in Palm Jumeirah?</h2>
            </motion.div>
        ...
        <section className="py-16 lg:py-20">
          <div className="container-luxury">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-display font-medium text-foreground mb-4">Featured Projects in Palm Jumeirah</h2>
              <p className="text-muted-foreground max-w-xl mx-auto">
                Browse verified off-plan projects on Palm Jumeirah from leading luxury developers.
              </p>
            </motion.div>
            <div className="text-center">
              <Button variant="hero" asChild>
                <Link to="/projects?area=Palm%20Jumeirah">
                  View All Palm Jumeirah Projects
            ...
            >
              ...
              <div className="relative z-10">
                <h2 className="text-2xl md:text-3xl font-display font-medium text-white mb-4">
                  Looking to invest on the Palm?
                </h2>
                <p className="text-white/60 mb-8 max-w-xl mx-auto">
                  Use our smart assistant to find your ideal beachfront project.
                </p>
                <Button variant="gold" size="lg" asChild>
                  <Link to="/ai-search">
