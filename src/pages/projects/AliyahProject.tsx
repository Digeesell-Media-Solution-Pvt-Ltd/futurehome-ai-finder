...
const projectData = {
  ...
  totalUnits: "346 Units",
  handover: "Ready",
  price: "AED 1.14M",
  roi: "7-9%",
  
  overview: `Aliyah is the perfect base for those who want to be in the heart of the 'dream city'. Experience a moment of calm, nestled inside Dubai Healthcare City, with chic, European-inspired design of serviced apartments set in a serene landscape.

This is a residence that offers you proximity to popular attractions at a conveniently calm distance. Creating a truly tranquil retreat in a vibrant urban location, Aliyah supports your exuberant lifestyle with panoramic views of Dubai.

Well connected, the residence puts the city buzz just far away enough, with easy access to Sheikh Zayed Road, Mohammed bin Zayed Road, and Dubai Creek.`,
  ...
  amenities: [
    { icon: Waves, name: "Swimming Pool", description: "Temperature-controlled pool with lounging area" },
    { icon: Dumbbell, name: "Fitness Center", description: "Fully equipped modern gym" },
    { icon: Car, name: "Covered Parking", description: "Secure garage parking for residents" },
    { icon: Store, name: "Retail Shops", description: "Ground floor retail and restaurants" },
    { icon: Shield, name: "24/7 Security", description: "Round-the-clock security and CCTV" },
    { icon: Home, name: "Elegant Lobby", description: "Stylish reception and lobby area" }
  ],

  connectivity: [
    { time: "2 min", destination: "Al Khail Road" },
    { time: "2 min", destination: "Dubai Creek" },
    { time: "4 min", destination: "Palazzo Versace Hotel" },
    { time: "5 min", destination: "Al Jaddaf Waterfront" },
    { time: "5 min", destination: "Sheikh Zayed Road" },
    { time: "6 min", destination: "Metro Station" },
    { time: "10 min", destination: "Downtown Dubai" },
    { time: "15 min", destination: "Dubai Mall" }
  ],

  gallery: [
    { src: heroImage, alt: "Aliyah Residences Exterior" },
            ...
            <div className="container-luxury">
              ...
              >
                <div className="flex flex-wrap items-center gap-3 mb-4">
                  ...
                  <span className="badge-tag">Healthcare City</span>
          ...
          <div className="container-luxury">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-xl font-semibold text-primary">{projectData.totalUnits}</p>
              </div>
              <div className="text-center">
            ...
            <div className="grid lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2 className="text-2xl font-display text-foreground mb-4">Make the City's Heart Your Home</h2>
                ...
                >
                  ...
                  <div className="bg-card border border-border rounded-xl p-6">
                    <p className="text-muted-foreground mb-6">
                      Aliyah is strategically positioned in Dubai Healthcare City, offering excellent connectivity to major destinations. Close to Dubai Creek, Downtown, and key highways, residents enjoy both tranquility and convenience.
                    </p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Aliyah Residences offers strong rental yield potential in Dubai Healthcare City, a prime area for medical professionals and expats. The location near Dubai Creek, combined with the ready-to-move status and competitive pricing, makes this an excellent choice for buy-to-let investors seeking consistent rental income in a high-demand area.
                      </p>
                    </div>
                  </div>
                </motion.div>
