...
import gardenImage from "@/assets/projects/la-tilia-garden.jpg";
import poolImage from "@/assets/projects/la-tilia-pool.jpg";

const LaTiliaProject = () => {
  const { openLeadCapture } = useLeadCapture();
  const [activeImage, setActiveImage] = useState(0);

  const images = [
    { src: heroImage, alt: "La Tilia at Villanova - Modern Townhouses by Dubai Properties" },
    { src: interiorImage, alt: "La Tilia - Contemporary Townhouse Interior" },
    { src: gardenImage, alt: "La Tilia - Landscaped Gardens & Community" },
    { src: poolImage, alt: "La Tilia - Community Swimming Pool" },
  ];

  const highlights = [
    { icon: Home, label: "3 & 4 BR Townhouses", description: "Family-sized homes" },
    { icon: Fence, label: "Gated Community", description: "Secure & private" },
    { icon: TreesIcon, label: "Nature-Focused", description: "Lush landscapes" },
    { icon: Route, label: "Prime Connectivity", description: "Emirates Road access" },
  ];
  ...
  const connectivity = [
    ...
    { icon: Route, destination: "Emirates Road", time: "Direct Access" },
    { icon: Route, destination: "Sheikh Mohammed Bin Zayed Road", time: "5 min" },
          ...
          <div className="container mx-auto">
            ...
            >
              ...
              <div className="flex items-center gap-2 text-white/90">
                ...
                <span className="text-lg">Villanova, Dubailand, Dubai</span>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
              ...
              <TabsContent value="overview" className="space-y-8">
                ...
                >
                  <h2 className="text-3xl font-display font-bold text-charcoal mb-6">
                    A Nature-Focused Family Community
                  </h2>
                  <div className="prose prose-lg max-w-none text-charcoal-light">
                    <p>
                      La Tilia is the newest phase in Villanova, where life expands within a gated, nature-focused community. Designed with families in mind, La Tilia blends thoughtful architecture with exquisite landscapes, creating an inviting environment that encourages connection.
                    </p>
                    <p>
                      Ideally positioned in Dubailand, Villanova offers exceptional connectivity to Dubai's most sought-after destinations. Located along Emirates Road with easy access to major routes like Sheikh Mohammed Bin Zayed Road and Al Ain Road, this community brings the city to your doorstep.
                    </p>
                  </div>
                </motion.section>
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <Card className="p-6 bg-gradient-to-br from-cream to-white">
                      ...
                      <h3 className="text-xl font-bold text-charcoal mb-2">Nature-Rich Living</h3>
                      <p className="text-muted-foreground">Exquisite landscapes and green spaces designed to foster connection and wellbeing for the entire family.</p>
                    </Card>
                    <Card className="p-6 bg-gradient-to-br from-cream to-white">
                      <Shield className="w-12 h-12 text-gold-dark mb-4" />
                      <h3 className="text-xl font-bold text-charcoal mb-2">Gated & Secure</h3>
                      <p className="text-muted-foreground">A private, gated community with 24/7 security ensuring peace of mind for families.</p>
                    </Card>
                    <Card className="p-6 bg-gradient-to-br from-cream to-white">
                      <Route className="w-12 h-12 text-gold-dark mb-4" />
                      <h3 className="text-xl font-bold text-charcoal mb-2">Prime Connectivity</h3>
                      <p className="text-muted-foreground">Direct access to Emirates Road, Sheikh Mohammed Bin Zayed Road, and Al Ain Road.</p>
                    </Card>
                    <Card className="p-6 bg-gradient-to-br from-cream to-white">
                      <Sparkles className="w-12 h-12 text-gold-dark mb-4" />
                      <h3 className="text-xl font-bold text-charcoal mb-2">Thoughtful Architecture</h3>
                      <p className="text-muted-foreground">Blending modern design with inviting layouts, creating homes built for comfortable family living.</p>
                    </Card>
                  </div>
                </motion.section>
              </TabsContent>
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <Card className="p-6 hover:shadow-lg transition-all border-gold-light/30">
                      ...
                      <p className="text-muted-foreground mb-4">Complete details about La Tilia including specifications, amenities, and community features.</p>
                      <Button variant="gold" className="w-full gap-2" onClick={() => openLeadCapture({ projectName: "La Tilia at Villanova", ctaType: "Download Brochure" })}>
                    ...
                    <Card className="p-6 hover:shadow-lg transition-all border-gold-light/30">
                      ...
                      <Button variant="gold-outline" className="w-full gap-2" onClick={() => openLeadCapture({ projectName: "La Tilia at Villanova", ctaType: "Download Floor Plan" })}>
                        <Download className="w-4 h-4" />
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              ...
              <Card className="p-6 bg-gradient-to-br from-charcoal to-charcoal-light text-white overflow-hidden relative">
                ...
                <div className="relative">
                  <div className="text-center mb-6">
                    <p className="text-cream/80 text-sm mb-1">Townhouses</p>
                    <p className="text-3xl font-bold text-gold-light">Villanova</p>
                    <p className="text-cream/70 text-sm">Dubailand, Dubai</p>
                  </div>
                  <div className="space-y-2 text-sm mb-6">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">Villanova, Dubailand</span>
                    </div>
                    <div className="flex justify-between">
              ...
              {/* CTA Buttons */}
              <div className="space-y-3">
                <Button className="w-full gap-2" variant="gold" onClick={() => openLeadCapture({ projectName: "La Tilia at Villanova", ctaType: "Request Details" })}>
                  <MessageSquare className="w-4 h-4" />
                  Request Details
                </Button>
                <Button className="w-full gap-2" variant="gold-outline" onClick={() => openLeadCapture({ projectName: "La Tilia at Villanova", ctaType: "Download Brochure" })}>
                  <FileText className="w-4 h-4" />
                  Download Brochure
                </Button>
                <Button className="w-full gap-2" variant="outline" onClick={() => openLeadCapture({ projectName: "La Tilia at Villanova", ctaType: "Book Consultation" })}>
                  <Download className="w-4 h-4" />
                  Book Consultation
                </Button>
              </div>
