...
import {
  ...
  Baby, Heart, Home, Zap, Users
} from "lucide-react";

import heroImg from "@/assets/projects/grove-ridge-hero.jpg";
import interiorImg from "@/assets/projects/grove-ridge-interior.jpg";
import poolImg from "@/assets/projects/grove-ridge-pool.jpg";
import parkImg from "@/assets/projects/grove-ridge-park.jpg";

const images = [heroImg, interiorImg, poolImg, parkImg];
...
const amenities = [
  ...
  { icon: Heart, label: "Yoga Area" },
  { icon: TreePine, label: "Landscaped Gardens" },
  { icon: Zap, label: "Padel Court" },
  { icon: Users, label: "Event Lawn" },
  { icon: TreePine, label: "BBQ Area" },
  { icon: Shield, label: "24/7 Security" },
];

const GroveRidgeProject = () => {
  const { openLeadCapture } = useLeadCapture();
  const [activeImage, setActiveImage] = useState(0);

  const handleCTA = (ctaType: string) => {
    openLeadCapture({ projectName: "Grove Ridge at Emaar South", ctaType });
  };
    ...
    <>
      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="relative h-[60vh] md:h-[70vh] overflow-hidden">
          <img src={images[activeImage]} alt="Grove Ridge at Emaar South by Emaar" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent" />
          <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12">
            <div className="max-w-7xl mx-auto">
              <Badge className="bg-primary/90 text-primary-foreground mb-3">Newly Launched</Badge>
              <h1 className="text-3xl md:text-5xl font-bold text-white mb-2 font-display">Grove Ridge at Emaar South</h1>
              ...
              <div className="flex flex-wrap gap-4 text-white/80 text-sm">
                ...
                <span className="flex items-center gap-1"><Building2 className="w-4 h-4" /> Apartment & Townhouse</span>
                ...
                <span className="flex items-center gap-1"><Banknote className="w-4 h-4" /> From AED 1,200,000</span>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="lg:col-span-2">
              <Tabs defaultValue="overview" className="w-full">
                ...
                <TabsContent value="overview" className="mt-6 space-y-6">
                  <div>
                    <h2 className="text-2xl font-bold text-foreground mb-4">About Grove Ridge at Emaar South</h2>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                      Grove Ridge at Emaar South is Emaar Properties' newest addition to the thriving Emaar South master community — a golf-front residential collection offering 1, 2, and 3-bedroom apartments alongside spacious 3-bedroom townhouses, starting from AED 1.2 million.
                    </p>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                      Tucked within the fairways of an 18-hole championship golf course, Grove Ridge is designed for families and investors who value lifestyle, green space, and long-term growth. Thoughtfully crafted interiors feature warm timber accents, marsh-green tones, and open-plan layouts built for modern family living with private gardens and direct golf views.
                    </p>
                    <p className="text-muted-foreground leading-relaxed">
                      Strategically positioned near Al Maktoum International Airport and Expo City Dubai, Grove Ridge sits at the affordable entry point of one of Dubai's fastest-growing investment corridors — a community with 22,700 residential units, 25 neighbourhood parks, and 53,000 sqm of retail space.
                    </p>
                  </div>

                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                      { label: "Types", value: "Apt & Townhouse" },
                      { label: "Bedrooms", value: "1BR – 3BR" },
                      { label: "Handover", value: "Q4 2028" },
                      { label: "Starting Price", value: "AED 1.2M" },
                    ].map((item) => (
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {["Golf Community", "Family Friendly", "Good Connectivity", "Gated Community"].map(tag => (
                ...
                {/* HOMES */}
                <TabsContent value="homes" className="mt-6 space-y-6">
                  <h2 className="text-2xl font-bold text-foreground mb-4">Unit Types</h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                      { type: "1 Bedroom Apartment", desc: "Compact, golf-facing layouts ideal for investors and young professionals." },
                      { type: "2 Bedroom Apartment", desc: "Spacious open-plan residences with large windows and garden-view balconies." },
                      { type: "3 Bedroom Apartment", desc: "Generous family apartments with premium kitchen and dining areas." },
                      { type: "3 Bedroom Townhouse", desc: "Exclusive townhomes with private gardens, direct green views, and extra living space." },
                    ].map((unit) => (
                      <Card key={unit.type} className="bg-muted/30">
                        <CardContent className="p-5">
                          ...
                          <Button size="sm" className="mt-3" onClick={() => handleCTA(`Enquire ${unit.type}`)}>
                            Enquire Now
                          </Button>
                        </CardContent>
                      </Card>
                ...
                <TabsContent value="amenities" className="mt-6">
                  ...
                  <div className="mt-8 p-5 bg-muted/30 rounded-xl">
                    <h3 className="text-lg font-semibold text-foreground mb-3">Golf Living</h3>
                    <p className="text-muted-foreground text-sm leading-relaxed">
                      Residents enjoy direct access to Emaar South's 18-hole championship golf course — one of the finest in the UAE. From tee-off at sunrise to after-round evenings at the golf point, the course defines the pace and personality of life at Grove Ridge.
                    </p>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="location" className="mt-6 space-y-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Emaar South is Dubai's most connected new community — positioned at the confluence of Al Maktoum International Airport (the world's largest when complete), Expo City Dubai, and major transport arteries linking south and central Dubai.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                  ...
                  <div className="p-5 bg-muted/30 rounded-xl">
                    <h3 className="text-lg font-semibold text-foreground mb-2">Emaar South Community</h3>
                    <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                      <li>22,700 residential units across the masterplan</li>
                      <li>18-hole championship golf course</li>
                      <li>25 neighbourhood parks</li>
                      <li>53,000 sqm retail and dining space</li>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {images.map((img, i) => (
                      <div key={i} className="rounded-xl overflow-hidden aspect-video">
                        <img src={img} alt={`Grove Ridge gallery ${i + 1}`} className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                      </div>
                    ))}
                  </div>
                </TabsContent>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Card className="bg-muted/30">
                      <CardContent className="p-6 flex flex-col items-center text-center gap-3">
                        ...
                        <p className="text-sm text-muted-foreground">Full project details, unit layouts, and community plan</p>
                    ...
                    <Card className="bg-muted/30">
                      <CardContent className="p-6 flex flex-col items-center text-center gap-3">
                        ...
                        <p className="text-sm text-muted-foreground">Detailed layouts for apartments and townhouses</p>
              ...
              <Card className="sticky top-24">
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="pt-4 border-t border-border">
                    ...
                    <p className="text-sm text-muted-foreground">Flexible construction-linked payment plan — low entry deposit with staggered milestones and final payment on completion.</p>
                  </div>
...
export default GroveRidgeProject;
