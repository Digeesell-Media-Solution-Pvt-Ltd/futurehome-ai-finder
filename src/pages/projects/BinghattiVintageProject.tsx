...
import { 
  ...
  Building2, Sparkles, Dumbbell, Car, Flame, Baby, Clock, Palette
} from "lucide-react";
            ...
            <div className="container-luxury">
              ...
              <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                <div className="flex flex-wrap items-center gap-3 mb-4">
                  <span className="badge-tag flex items-center gap-1"><Palette className="w-3 h-3" />Retro Modern</span>
            ...
            <div className="grid lg:grid-cols-3 gap-12">
              <div className="lg:col-span-2 space-y-12">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">{projectData.highlights.map((h, i) => (<div key={i} className="flex items-start gap-3 p-4 bg-muted/50 rounded-lg"><Palette className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground">{h}</span></div>))}</div>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                  ...
                  <div className="bg-card border border-border rounded-xl p-6">
                    <p className="text-muted-foreground mb-6">Vintage is located in Majan, a prime block offering excellent connectivity across Dubai.</p>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 rounded-xl p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div><h3 className="text-lg font-semibold text-foreground mb-2">AI Investment Insight</h3><p className="text-muted-foreground">Binghatti Vintage is lifestyle-oriented, ideal for creative buyers and short-stay rental operators. The distinctive retro-modern aesthetic creates a unique market position.</p></div>
                  </div>
                </motion.div>
              </div>
