...
import heroImage from "@/assets/projects/samana-hills-south2-hero.jpg";
...
const projectData = {
  ...
  overview: `Samana Hills South 2 is the highly anticipated phase expansion of the successful Samana Hills family-centric development. This mid-rise residential project brings premium Arjan living within reach, offering thoughtfully designed apartments that prioritize family comfort and suburban tranquility.

With open floor planning and spacious layouts, each residence is crafted to accommodate growing families. The development features a central courtyard design that encourages community interaction while maintaining privacy for residents.

Located near Mediclinic Parkview and essential services, Hills South 2 offers the perfect balance of accessibility and peaceful suburban living, making it an ideal choice for families seeking quality without compromise.`,

  highlights: [
    "Family-Friendly Design",
    "1 & 2 BR Configurations",
    "Open Floor Planning",
    "Central Courtyard",
    "Jogging Paths",
    "Near Mediclinic Parkview"
  ],

  amenities: [
    { icon: TreePine, name: "Courtyard Garden", description: "Landscaped central space" },
    { icon: Waves, name: "Swimming Pool", description: "Family-friendly pool area" },
    { icon: Users, name: "Jogging Paths", description: "Dedicated fitness trails" },
    { icon: Baby, name: "Kids Play Area", description: "Safe outdoor playground" },
    { icon: Dumbbell, name: "Fitness Center", description: "Modern gym facilities" },
    { icon: Car, name: "Covered Parking", description: "Secure parking spaces" }
  ],

  connectivity: [
    { time: "3 min", destination: "Mediclinic Parkview" },
  ...
  gallery: [
    { src: heroImage, alt: "Samana Hills South 2" },
    { src: interiorImage, alt: "Open Floor Interior" },
    { src: poolImage, alt: "Swimming Pool" },
    { src: courtyardImage, alt: "Courtyard Garden" }
  ]
};

export default function SamanaHillsSouth2Project() {
  const handleWhatsApp = () => {
    window.open("https://wa.me/971565204129?text=Hi, I'm interested in Samana Hills South 2 in Arjan", "_blank");
  };
            ...
            <div className="container-luxury">
              ...
              >
                <div className="flex flex-wrap items-center gap-3 mb-4">
                  ...
                  <span className="badge-tag">Affordable Living</span>
            ...
            <div className="grid lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2 className="text-2xl font-display text-foreground mb-4">Your Second Chance at Premium Arjan Living</h2>
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2 className="text-2xl font-display text-foreground mb-6">Family-Focused Amenities</h2>
                  <div className="grid sm:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div className="bg-card border border-border rounded-xl p-6">
                    <p className="text-muted-foreground mb-6">
                      Hills South 2 enjoys a prime location in Arjan, just minutes from Mediclinic Parkview and essential family services. The development offers quick access to Dubai's major attractions while maintaining the peaceful suburban atmosphere families desire.
                    </p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Samana Hills South 2 delivers reliable returns for investors targeting long-term tenants. The family-centric design and proximity to healthcare facilities create strong appeal for expatriate families, ensuring consistent occupancy rates. As a phase expansion of a proven development, it benefits from established community trust and reduced investment risk.
                      </p>
                    </div>
                  </div>
                </motion.div>
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-24 space-y-6">
                  ...
                  >
                    <h3 className="text-lg font-semibold text-foreground mb-4">Interested in Hills South 2?</h3>
