...
export default function BinghattiLuxuriaProject() {
  const handleWhatsApp = () => {
    window.open("https://wa.me/971000000000?text=Hi, I'm interested in Binghatti Luxuria in JVT", "_blank");
  };
                ...
                >
                  ...
                  <div className="bg-card border border-border rounded-xl p-6">
                    <p className="text-muted-foreground mb-6">
                      Strategically located in Jumeirah Village Triangle, Binghatti Luxuria offers excellent connectivity to Dubai's major destinations. The community provides a perfect blend of suburban tranquility and urban accessibility.
                    </p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Binghatti Luxuria is perfect for investors targeting high ROI in a rapidly developing area. JVT offers excellent rental demand from young professionals and families, with competitive entry prices compared to neighboring communities. The Binghatti brand's distinctive architecture creates strong resale appeal and tenant attraction.
                      </p>
                    </div>
                  </div>
                </motion.div>
